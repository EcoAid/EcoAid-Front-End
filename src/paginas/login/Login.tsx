...
function Login() {
    ...
    return (
        <div className="z-0 flex flex-col items-center justify-center h-screen w-screen">
            <div className="z-0 px-24 py-36 bg-white rounded-lg border border-gray-100 shadow-xl">
