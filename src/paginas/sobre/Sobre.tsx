...
function Sobre() {
    return (
        <div className=" mx-auto justify-center text-center text-[#414141] p-32 bg-white">

            <div className="flex flex-col gap-24 justify-center ">
                <div>
                    <h2 className="mb-16 font-bold text-4xl sm:text-5xl ">Sobre o <span className=" bg-clip-content bg-isabelline text-green-700">EcoAid</span>
                    </h2>
                ...
                <div>
                    <h2 className="mb-16 font-bold text-4xl sm:text-5xl">Nossos <span className="bg-clip-content bg-isabelline text-green-700">membros</span>
                    </h2>
