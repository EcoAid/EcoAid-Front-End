...
function home() {
    return (
        <>
            <main>
                <div className='w-full p-24 text-6xl text-[#333333] bg-white'>
                ...
                <div className='w-full p-12 flex flex-row justify-center gap-8'>
                    <form className="w-3/5">
                        <div className="relative">
                            ...
                            <input type="search" id="default-search" className="block w-full p-8 ps-24 text-2xl text-[#414141] rounded-3xl bg-white placeholder-[#414141]" placeholder="Procure por doações" required />
                        </div>
                    </form>
                    <button><SlidersHorizontal size={64} color='#407C44' /></button>
                </div>

                <section className='w-full part-white text-[#407C44] p-20 text-6xl flex flex-col gap-16 overflow-visible'>
                    <h1>Doações recomendadas</h1>
                    <h2 className='text-4xl text-[#3D4DA6]'>Novas doações</h2>
                    <div className='flex flex-row gap-24'>
                        <div className='bg-white w-2/7 shadow-2xl flex flex-col gap-4 justify-center box-border p-12 px-24 rounded-3xl text-center'>
                ...
                <section className='w-full part-white text-[#407C44] p-20 text-6xl flex flex-col gap-16 overflow-visible'>
                    <div className='flex flex-row items-center gap-16'>
                        ...
                        <button className='text-4xl text-[#3D4DA6]'>Mais populares</button>
                        <button className='text-4xl text-[#3D4DA6]'>Top doações</button>
                    </div>
                    <div className='flex flex-row gap-24'>
                        <div className='bg-white w-2/7 shadow-2xl flex flex-col gap-4 justify-center box-border p-12 px-24 rounded-3xl text-center'>
                            <Heart className='ml-auto' size={64} color="#407C44" />
